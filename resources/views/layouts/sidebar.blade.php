<aside class="sidebar text-white" id="sidebar">
    <div class="p-4 flex flex-col h-full">
        ...
        <nav class="space-y-1 flex-1">
            ...
            <a href="{{ route('pelerin.documents.index') }}" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('pelerin.documents.*') ? 'bg-green-600/80 text-white' : 'hover:bg-white/10 text-white' }}">
        ...
        <nav class="space-y-2 flex-1 min-h-0 overflow-y-auto">
            ...
            @role('agence')
                ...
                <a href="{{ route('documents.index') }}" class="flex items-center px-4 py-3 rounded-lg hover:bg-dark-green transition {{ request()->routeIs('documents.*') ? 'bg-dark-green' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    <span class="sidebar-text">Documents</span>
