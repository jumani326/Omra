...
@section('page-title', 'Notifications agence')
@section('page-description', 'Consultez les notifications liées à votre agence et à vos dossiers pèlerins.')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 font-poppins">Notifications agence</h1>
            <p class="text-gray-600 mt-1 text-sm">Suivez les nouvelles candidatures, mises à jour de dossiers et alertes opérationnelles.</p>
        </div>
        <div class="flex items-center gap-2">
            ...
            <form action="{{ route('agence.notifications.readAll') }}" method="POST">
                @csrf
    ...
    @if($notifications->isEmpty())
        <div class="bg-white rounded-xl shadow-md border border-gray-100 p-10 text-center">
            ...
            <p class="text-gray-500 text-sm mt-1">Vous verrez ici les nouvelles candidatures et mises à jour importantes.</p>
        </div>
    @else
        <div class="space-y-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-2 flex items-center gap-3">
                            @if(is_null($notification->read_at))
                                <form action="{{ route('agence.notifications.read', $notification) }}" method="POST">
                                    @csrf
