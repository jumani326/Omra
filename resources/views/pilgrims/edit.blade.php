...
@section('page-title', 'Modifier Pèlerin')
@section('page-description', 'Modifier les informations du pèlerin')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form action="{{ route('pilgrims.update', $pilgrim) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="first_name" value="{{ old('first_name', $pilgrim->first_name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="last_name" value="{{ old('last_name', $pilgrim->last_name) }}" required
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $pilgrim->email) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $pilgrim->phone) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="passport_no" value="{{ old('passport_no', $pilgrim->passport_no) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nationality" value="{{ old('nationality', $pilgrim->nationality) }}" required
                ...
                <div>
                    ...
                    <select name="package_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-primary-green focus:ring-primary-green">
                        ...
                        @foreach(\App\Models\Package::where('slots_remaining', '>', 0)->orWhere('id', $pilgrim->package_id)->get() as $package)
                ...
                <div>
                    ...
                    <select name="group_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-primary-green focus:ring-primary-green">
                        ...
                        @foreach($groups ?? [] as $g)
                            <option value="{{ $g->id }}" {{ old('group_id', $pilgrim->group_id) == $g->id ? 'selected' : '' }}>{{ $g->name }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="status" class="w-full border-gray-300 rounded-md shadow-sm focus:border-primary-green focus:ring-primary-green">
                        <option value="pending" {{ old('status', $pilgrim->status) == 'pending' ? 'selected' : '' }}>En attente de validation</option>
                        <option value="registered" {{ old('status', $pilgrim->status) == 'registered' ? 'selected' : '' }}>Inscrit</option>
                        <option value="dossier_complete" {{ old('status', $pilgrim->status) == 'dossier_complete' ? 'selected' : '' }}>Dossier complet</option>
                        <option value="visa_submitted" {{ old('status', $pilgrim->status) == 'visa_submitted' ? 'selected' : '' }}>Visa déposé</option>
                        <option value="visa_approved" {{ old('status', $pilgrim->status) == 'visa_approved' ? 'selected' : '' }}>Visa approuvé</option>
                        <option value="departed" {{ old('status', $pilgrim->status) == 'departed' ? 'selected' : '' }}>Parti</option>
                        <option value="returned" {{ old('status', $pilgrim->status) == 'returned' ? 'selected' : '' }}>Revenu</option>
                    </select>
                </div>
            </div>
            ...
            <div class="mt-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Documents Existants</h3>
            ...
            <!-- Nouveaux documents -->
            <div class="mt-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Ajouter des Documents</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('pilgrims.show', $pilgrim) }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                    Annuler
                </a>
