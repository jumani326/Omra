...
<body class="min-h-screen flex items-center justify-center py-12 px-4">
    <div class="max-w-md w-full space-y-6 bg-white p-8 rounded-2xl shadow-2xl">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 font-poppins">Nouveau mot de passe</h2>
            <p class="mt-1 text-sm text-gray-600">Saisissez le code à 8 chiffres reçu par email, puis votre nouveau mot de passe.</p>
        </div>
        ...
        <form action="{{ route('password.update') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input id="code" name="code" type="text" required maxlength="8" pattern="[0-9]{8}" placeholder="12345678"
                       ...
                       inputmode="numeric" value="{{ old('code') }}">
            </div>
            <div>
